...
// Define version.
    ...
    define("DISABLEUPDATESMANAGERVERSION", "4.0.1");
...
<body>
    <div class="wrap">
        <h2><span style=
        "display:block; padding-left: 5px; padding-bottom: 5px"><?php _e('Disable Updates Manager Settings','disable-updates-manager'); ?></span></h2>
        ...
        <form action="options.php" method="post">
            ...
            <table class="wp-list-table widefat fixed bookmarks" style=
            "width: 590px; border-radius: 4px;">
                <thead>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="showonhover">
                                <label for="all_notify"><input id="all_notify"
                                name="_disable_updates[all]" type="checkbox"
                                value="1">
                                <?php _e('Disable All Updates', 'disable-updates-manager') ?></label>
                                <span><a class="viewdescription" href="#">?</a>
                                <span class="hovertext">Just disables core,
                                theme, and plugin updates.</span></span>
                            </div><span style=
                            "padding-left: 12px; display:block"><label for=
                            "plugins_notify"><input id="plugins_notify" name=
                            "_disable_updates[plugin]" type="checkbox" value=
                            "1">
                            <?php _e('Disable Plugin Updates', 'disable-updates-manager') ?></label><br>

                            <label for="themes_notify"><input id=
                            "themes_notify" name="_disable_updates[theme]"
                            type="checkbox" value="1">
                            <?php _e('Disable Theme Updates', 'disable-updates-manager') ?></label><br>

                            <label for="core_notify"><input id="core_notify"
                            name="_disable_updates[core]" type="checkbox"
                            value="1">
                            <?php _e('Disable WordPress Core Update', 'disable-updates-manager') ?></label></span>
                        </td>
                    </tr>
                </tbody>
            </table><br>
            ...
            "width: 590px; border-radius: 4px;">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="showonhover">
                                <label for="ip_notify"><input id="ip_notify"
                                name="_disable_updates[ip]" type="checkbox"
                                value="1">
                                <?php _e('Disable Plugins Individually', 'disable-updates-manager') ?></label>
                                <span><a class="viewdescription" href="#">?</a>
                                <span class="hovertext">Go to the "Plugins"
                                section in your dashboard to
                                disable.</span></span>
                            </div>
                        </td>
                    </tr>
            ...
            "width: 590px; border-radius: 4px;">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="showonhover">
                                <label for="page_notify"><input id=
                                "page_notify" name="_disable_updates[page]"
                                type="checkbox" value="1">
                                <?php _e('Remove Updates Page', 'disable-updates-manager') ?></label>
                                <span><a class="viewdescription" href="#">?</a>
                                <span class="hovertext">The one in the
                                dashboard tab.</span></span>
                            </div>

                            <div class="showonhover">
                                <label for="wpv_notify"><input id="wpv_notify"
                                name="_disable_updates[wpv]" type="checkbox"
                                value="1">
                                <?php _e('Remove WordPress Core Version', 'disable-updates-manager') ?></label>
                                <span><a class="viewdescription" href="#">?</a>
                                <span class="hovertext">Removes it for all
                                users.</span></span>
                            </div><label for="abup_notify"><input id=
                            "abup_notify" name="_disable_updates[abup]" type=
                            "checkbox" value="1">
                            <?php _e('Disable Automatic Background Updates', 'disable-updates-manager') ?></label><br>
                            </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="wp-list-table widefat fixed bookmarks" style=
            "width: auto; padding: 5px; border-radius: 4px;">
                <tbody>
                    <tr>
                        <td>
                            <p style="text-align: center"><a href=
                            "http://wordpress.org/support/plugin/stops-core-theme-and-plugin-updates">
                            Support</a> | <a href=
                            "http://www.youtube.com/watch?v=7sMEBGNxhwA">Tutorial</a>
                            | <a href=
                            "http://wordpress.org/plugins/stops-core-theme-and-plugin-updates/faq/">
                            FAQ</a> | <a href=
                            "https://github.com/Websiteguy/disable-updates-manager">
                            GitHub</a></p>
                        </td>
                    </tr>
                </tbody>
            ...
            <div class="error" style="width: 780px;">
                <p><strong>Please Note! -</strong> If either your WordPress
                core, theme, or plugins get too out of date, you may run into
